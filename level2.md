...
독서는 확실히 어떤 개념을 빠르게 이해하기 좋은 방법이었다. 책에는 독자를 이해시키기 위한 많은 스토리텔링, 그림 자료, 예시가 있다. 즉, 책은 독자가 어떤 걸 학습하기 원하는지 명확히 알고 있고 그것을 목표하고 있다. 하지만 이 방법에는 커다란 함정이 있다. 책을 읽은 후에 그것이 내 지식이 되었다고 착각하기 쉽다는 점이다.
